...
class ChatComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      profilePhoto: JSON.parse(displayName).image,
      displayName: JSON.parse(displayName).image,
    });
    addResponseMessage('Welcome to ExecuteIT Chat !!');
...
//     if (
//       JSON.parse(event.user.displayName).displayName === this.state.displayName
//     ) {
//       author = "me";
//     }
    ...
    return (
      <div style={{ zIndex: 1000000 }}>
        ...
        /> */}
         ...
         <Widget
          handleNewUserMessage={this.onMessageWasSent()}
          profileAvatar={logo}
          title="Execute-IT"
          subtitle="Chat Here"
        />
